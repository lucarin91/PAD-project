...
public class GossipSettings {
  ...
  /** Time between com.google.code.gossip'ing in ms. Default is 1 second. */
   ...
   *          The com.google.code.gossip interval in ms.
  ...
  /**
   * Set the com.google.code.gossip interval. This is the time between a com.google.code.gossip message is send.
   * 
   * @param gossipInterval
   *          The com.google.code.gossip interval in ms.
   */
  ...
  /**
   * Get the com.google.code.gossip interval.
   * 
   * @return The com.google.code.gossip interval in ms.
   */

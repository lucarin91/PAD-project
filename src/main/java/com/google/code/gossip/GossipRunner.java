...
public class GossipRunner {
  ...
  public static void main(String[] args) {
    ...
    if (args.length == 1) {
      ...
      configFile = new File("com.google.code.gossip.conf");
    }
  ...
  public GossipRunner(File configFile) {
    ...
    if (configFile != null && configFile.exists()) {
      try {
        ...
        System.err.println("Error while starting the com.google.code.gossip service: " + e.getMessage());
      }
    } else {
      System.out
              .println("The com.google.code.gossip.conf file is not found.\n\nEither specify the path to the startup settings file or place the com.google.code.gossip.json file in the same folder as the JAR file.");
    }
  }
}

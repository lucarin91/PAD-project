...
/**
 * [The active thread: periodically send com.google.code.gossip request.] The class handles gossiping the membership
...
abstract public class ActiveGossipThread implements Runnable {
   ...
   * of the list to com.google.code.gossip with.
   *
   * @param memberList
   *          The list of members which are stored in the local list of members.
   * @return The chosen LocalGossipMember to com.google.code.gossip with.
   */

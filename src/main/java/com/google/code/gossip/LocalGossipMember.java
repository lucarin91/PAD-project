...
/**
 * This object represent a com.google.code.gossip member with the properties known locally. These objects are stored
 * in the local list of com.google.code.gossip member.s
 *
 * @author harmenw
 */
public class LocalGossipMember extends GossipMember {
  /** The timeout timer for this com.google.code.gossip member. */
   ...
   *          The cleanup timeout for this com.google.code.gossip member.
   */

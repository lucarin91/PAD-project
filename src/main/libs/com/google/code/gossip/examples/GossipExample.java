...
/**
 * This class is an example of how one could use the com.google.code.gossip service. Here we start multiple com.google.code.gossip
...
public class GossipExample extends Thread {
  ...
  public void run() {
    try {
      ...
      // Create the com.google.code.gossip members and put them in a list and give them a port number starting with
      // 2000.
      ...
      // Lets start the com.google.code.gossip clients.
      ...
      // After starting all com.google.code.gossip clients, first wait 10 seconds and then shut them down.
      sleep(10000);

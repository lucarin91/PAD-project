...
/**
 * [The passive thread: reply to incoming com.google.code.gossip request.] This class handles the passive cycle,
 * where this client has received an incoming message. For now, this message is always the
 * membership list, but if you choose to com.google.code.gossip additional information, you will need some logic to
...
abstract public class PassiveGossipThread implements Runnable {
  ...
  /** The socket used for the passive thread of the com.google.code.gossip service. */
